		...
		<div class="col-12"></div>
			<div class="col-12" >
				...
				<table  class="table table-striped table-hover" >
					<tr><th>選擇</th><th>系助ID</th><th>系級</th><th>系助姓名</th><th>辦公室</th>
    				<th>分機</th><th>Email</th></tr>	
			</div>
		<div class="col-12"></div>
	</div>
</div>
...
try
{
  ...
  ResultSet rs=stmt.executeQuery("select DA.DAID, DA.DepartmentID, DA.DAName ,DA.Room ,DA.Ext,DA.[E-mail] from DA");
  while(rs.next())
  {
    out.print("<tr>");
	out.print("<td>");
	out.print("<input type=checkbox name=delete value='"+rs.getString("Ext")+"'");
	out.print("</td>");
	out.print("<td>"+rs.getString("DAID")+"</td>");
	out.print("<td>"+rs.getString("DepartmentID")+"</td>");
	out.print("<td>"+rs.getString("DAName")+"</td>");
