...
ResultSet rs = odbcbean.doSelect("select Professor.ProfessorID, Professor.DepartmentID, Professor.ProfessorName ,Professor.Room ,Professor.Ext,Professor.[E-mail] from Professor where Professor.DepartmentID=4;") ;
%>
<html>
<head>
...
<p align="center">
<p align="center">
<form name="form1" method="post" action="im_professor_update1.jsp">
...
<form name="form2" method="post" action="im_professor_update2.jsp">

<table border="1" width="100%" id="table1">
<form name="Delete" action="im_remove2.jsp" method="POST">
