...
try{
  ...
  String sql= "select Professor.ProfessorName,Professor.Room,Professor.Ext,Professor.[E-mail],Department.DepartmentName  from Professor,Department where Department.DepartmentID= Professor.DepartmentID and Professor.DepartmentID='3'";
