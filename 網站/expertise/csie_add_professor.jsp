...
try{
  ...
  String sql= "select Professor.ProfessorName,Expertise.ExpertiseID,Expertise.ExpertiseName from Professor,Department,PE,Expertise where Department.DepartmentID= Professor.DepartmentID and Professor.ProfessorID=PE.ProfessorID and PE.ExpertiseID=Expertise.ExpertiseID and Professor.DepartmentID<=4";
