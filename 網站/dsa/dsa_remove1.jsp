...
try
{
  ...
  ResultSet rs=stmt.executeQuery("select Professor.ProfessorID, Professor.DepartmentID, Professor.ProfessorName ,Professor.Room ,Professor.Ext,Professor.[E-mail] from Professor where Professor.DepartmentID=2;");
  while(rs.next())
  {
    out.print("<tr>");
	out.print("<td>");
